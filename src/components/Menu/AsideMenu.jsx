...
class AsideMenu extends Component {
  ...
  render() {
    const { currentUser, isChoose, openSideBar } = this.props;
    return (
      <>
        <div className="fixed w-full z-10">
          {openSideBar ? (
            <div className="flex fixed mt-14 left-0 right-0 bg-white bottom-0 top-0  flex-col md:w-60 border-gray-400 md:mt-14 text-sm z-30 ">
              <Link
                to="/"
                onClick={() => this.handleChooseAsideButton("home")}
                className={
                  isChoose === "home"
              ...
              <Link
                to="/explore"
                onClick={() => this.handleChooseAsideButton("explore")}
                className={
                  isChoose === "explore"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              {currentUser && currentUser.displayName ? (
                <>
                  <Link
                    to="/subscriptions"
                    onClick={() =>
                      this.handleChooseAsideButton("subscriptions")
                    }
                    className={
                  ...
                  <Link
                    to="/liked-videos"
                    onClick={() => this.handleChooseAsideButton("liked-videos")}
                    className={
              ...
              <button
                onClick={() => this.handleChooseAsideButton("music")}
                className={
                  isChoose === "music"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              <button
                onClick={() => this.handleChooseAsideButton("sport")}
                className={
                  isChoose === "sport"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              <button
                onClick={() => this.handleChooseAsideButton("games")}
                className={
                  isChoose === "games"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              <button
                onClick={() => this.handleChooseAsideButton("news")}
                className={
                  isChoose === "news"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              <button
                onClick={() => this.handleChooseAsideButton("live")}
                className={
                  isChoose === "live"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
              ...
              <button
                onClick={() => this.handleChooseAsideButton("360 video")}
                className={
                  isChoose === "360 video"
                    ? "flex items-center px-6 py-2 bg-gray-200 hover:bg-gray-300 font-semibold"
                    : "flex items-center px-6 py-2 hover:bg-gray-100 font-light"
