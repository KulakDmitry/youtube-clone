  ...
  render() {
    ...
    return (
      <div
        ...
        } pt-32 bg-gray-50 h-fit grid gap-x-4 gap-y-8 grid-cols-4 grid-rows-auto p-6`}
      >
        {state.video.map((i) => (
          <div key={i.id}>
            <div>
              <img src={`${i.snippet.thumbnails.medium.url}`} alt="" />
              <span className="relative z-30 bottom-6 right-1 rounded-sm text-white bg-black text-xs p-px mb-1">
            ...
            <div className="pt-4 ">
              ...
              <p className="flex flex-col">
                ...
                <span className="text-xs font-light">
                  {parseInt(i.statistics.viewCount)} / {i.snippet.publishedAt}
                </span>
              </p>
            </div>
          </div>
