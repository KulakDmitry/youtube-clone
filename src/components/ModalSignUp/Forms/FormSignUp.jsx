...
const FormSignUp = ({ handleSubmitSignUp }) => {
  return (
    <Formik
      ...
      {({ errors, touched }) => (
        <Form className="flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <Field className="border border-gray-300 text-lg" name="username" />
          </div>
          {errors.username && touched.username ? (
            <div className="text-center text-red-600">{errors.username}</div>
          ) : null}
          <div className="flex justify-between items-center mt-4">
